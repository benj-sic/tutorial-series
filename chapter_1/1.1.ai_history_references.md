...
* [Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks](https://arxiv.org/abs/2005.11401) — Lewis _et al._ (2020). Introduced Retreival-Augmented Generation (RAG), allowing models to connect to external databases and incorporate new information without needing to be re-trained.
