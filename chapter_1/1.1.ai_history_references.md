...
This page collects references we've found useful in understanding key developments and how we got to the AI agents we use today. If you're looking to learn more about the evolution of AI, large language models (LLMs), and their applications in science, the links below may help. Otherwise, we suggest skipping forward to {doc}`Chapter 2 <../chapter_2/2.1.background>` to the practical applications of AI agents in biology.

## 1.1.1 Foundational Papers
...
## 1.1.3 Perspectives on AI History
...
## 1.1.4 Additional Resources on LLMs and Deep Learning
